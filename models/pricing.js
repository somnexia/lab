...
// Создаем класс Pricing для представления курса.
class Pricing {
    // Конструктор класса Pricing принимающий заголовок, цену и изображение курса.
...
module.exports = Pricing; // Экспортируем класс Pricing для использования в других модулях.
