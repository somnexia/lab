...
Для пояснительной можно продублировать сводную таблицу в diagrams.net (как в booking-проекте).  
Исходник таблицы для отчёта — этот файл; PNG/PDF — экспорт из draw.io при необходимости.
